...
func _update_modulate() -> void:
	...
	if current_state == "uncontrolled":
		...
		return
	match current_state:
		"source":      sprite.modulate = Color(0.6, 1.8, 0.6)
		"target":      sprite.modulate = Color(1.8, 0.6, 1.8)
		"transmitter": sprite.modulate = Color(0.7, 1.5, 1.8)
		"controlled":  sprite.modulate = Color.WHITE
